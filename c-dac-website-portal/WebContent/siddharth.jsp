...
<body bgcolor="white" link="cyan" alink="cyan" vlink="cyan">
	...
	<center>
	<font color="darkGreen" size="5"><u>Member Details</u></font>
	</center>
	
	<br>
	
	<table width="1200" border="7" cellspacing="20" cellpadding=""
		align="center">
		
	<tr><td>NAME</td><td>EMP-NO.</td><td>DESIGNATION</td><td>PROJECT</td><td>DEPARTMENT</td><td>EMAIL</td><td>MOBILE</td></tr>
	<tr><td>Siddharth Shishodia</td><td>341832</td><td>Project Engineer II</td><td>BIS</td><td>E-Governance</td><td>siddharthshishodia@cdac.in</td><td>8447967793</td></tr>
	...
	<hr color="black">
		...
		<fieldset>
			<legend align="center">
				<h2><font color="pink">ADDITIONAL LINKS</font></h2>
			</legend>
			<table align="center" cellspacing="35px">

				<tr>
					<td><h3><font color="pink">ABOUT C-DAC</font></h3></td>
					<td><h3><font color="pink">HELP</font></h3></td>
					<td><h3><font color="pink">MORE</font></h3></td>
				</tr>
				<tr>
...
<br>
		...
		<table align="center">
			<tr>
				...
				<td>
					<center>
						<i><b><font color="lime">Developed and Designed by <font color="aqua">AKSHAY RAINA</font> at <a
