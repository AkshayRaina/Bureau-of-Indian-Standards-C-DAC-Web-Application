...
<body bgcolor="white" link="cyan" alink="cyan" vlink="cyan">
 ...
 %>
	...
	<font size="5" color="DARKBLUE"><marquee>**********************************************
		...
		<fieldset>
<legend align="center"><h1>YOUR DETAILS ARE DISPLAYED HERE</h1></legend>
<br>
<table width="700" border="7" cellspacing="20" cellpadding=""
		align="center">
<tr>
<td><I>FIRST NAME</td>
...
<tr>
<td><I>EMPLOYEE ID</td>
<td><%=request.getParameter("empid")%></td>
</tr>
<tr>
<td><I>EMAIL ID</td>
...
<tr>
<td><I>DESIGNATION</td>
<td><%=request.getParameter("id_card")%></td>
</tr>
<tr>
<td><I>OFFICE BRANCH</td>
